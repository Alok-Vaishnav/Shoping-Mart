...
function Navbar() {
    ...
    return (
        <div className="fixed z-[9999] h-[60px] w-full bg-[rgb(20,20,20)] px-3 md:px-6">
            <div className="flex h-full items-center justify-between">
                ...
                <nav className="hidden h-full flex-1 items-center justify-between md:flex md:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-4 lg:gap-6">
                        ...
                        <button onClick={() => setIsCart(p => !p)} className="cursor-pointer">
